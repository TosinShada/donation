...
import { LearnMore, NavLink } from 'components/link';
          ...
          <Container>
            <Box sx={styles.headerInner}>
              ...
              >
                ...
                >
                  {menuItems.map(({ path, label, isExternal }, i) => (
                    label === 'Donate' ?
                      <li key={i}>
                        <LearnMore
                          path={path}
              ...
              {mobileMenu ? (
                ...
                <MenuButton aria-label="Toggle Menu" onClick={openMobileMenu} sx={styles.openButton} />
              )}
            </Box>
          </Container>
        </Box>
